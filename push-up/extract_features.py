...
down_augmented_paths = augment_images_in_folder("push-up/down", "push-up/down_augmented")
up_augmented_paths = augment_images_in_folder("push-up/up", "push-up/up_augmented")

down_data, down_data_resnet, down_data_effnet, down_labels = load_data("push-up/down", 1)
up_data, up_data_resnet, up_data_effnet, up_labels = load_data("push-up/up", 0)
...
np.save('push-up/X.npy', X)
np.save('push-up/y.npy', y)
np.save('push-up/X1.npy', X_resnet)
np.save('push-up/X2.npy', X_effnet)
