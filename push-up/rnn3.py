...
# Load dữ liệu
X = np.load('push-up/X2.npy')
y = np.load('push-up/y.npy')
...
plt.ylabel('Metrics')
plt.legend()
plt.title('Validation Metrics and Loss over Epochs in Mediapipe+Effnet+RNN')
plt.show()

plt.savefig('push-up/mediapipe_effnet_rnn.png')

model.save('push-up/effnetrnn.h5')
