...
down_augmented_paths = augment_images_in_folder("pull-up/down", "pull-up/down_augmented")
up_augmented_paths = augment_images_in_folder("pull-up/up", "pull-up/up_augmented")

down_data, down_data_resnet, down_data_effnet, down_labels = load_data("pull-up/down", 1)
up_data, up_data_resnet, up_data_effnet, up_labels = load_data("pull-up/up", 0)
...
np.save('pull-up/X.npy', X)
np.save('pull-up/y.npy', y)
np.save('pull-up/X1.npy', X_resnet)
np.save('pull-up/X2.npy', X_effnet)
